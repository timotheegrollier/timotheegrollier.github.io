                ...
                <header className="home-page__header">
                    <div className="profile-wrapper">
                        <div className="profile-image-container">
                            <img src="/media/timo.jpg" alt="Timothée Grollier" className="profile-image" />
                    ...
                    <h2 className="home-page__role">Lead Développeur Full-Stack & DevOps</h2>
                    ...
                    <p className="home-page__description">
                        ...
                        Je transforme des problèmes complexes en solutions élégantes et scalables.
                    </p>
