    ...
    return (
        <section className="contact-page" id="contact">
            ...
            <div className="contact-page__grid">
                {/* Contact info */}
                <div className="contact-page__info" id="contact-info">
                    <CopyableField
                        icon={
                            <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                                <path d="M13 6c0 4-5 8-5 8S3 10 3 6a5 5 0 1110 0z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
                    ...
                    <CopyableField
                        ...
                        label="Téléphone"
                        value="0695024008"
                        displayValue={socialLinks.phone}
                    />
                </div>

                {/* Social links */}
                <div className="contact-page__social" id="contact-social">
                    <h3 className="contact-page__social-title">Retrouvez-moi sur</h3>
